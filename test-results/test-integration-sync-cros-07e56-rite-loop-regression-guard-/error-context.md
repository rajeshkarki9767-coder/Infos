...
- Name: test/integration/sync.spec.js >> cross-device sync >> shared_state version is stable while idle (write-loop regression guard)
- Location: test/integration/sync.spec.js:79:3
